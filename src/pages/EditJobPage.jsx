...
import { ToastContainer,toast } from 'react-toastify'; 
  ...
  const EditJobPage = ({ editedJobSubmit }) => {
    ...
    const [companyDes, setCompanyDes] = useState(company.description);
        ...
        <form onSubmit={submitForm} >
          ...
          <div className="mb-4">
            ...
            >
              ...
              <option value="$90K - 100K">$90K - $10 0K</option>
          ...
          <div>
            <button
              className="bg-red-700 hover:bg-red-600 text-white cursor-pointer font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline"
              type="submit"
            >
              Save Changes
            </button>
