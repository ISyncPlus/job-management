        ...
        <div className="grid grid-cols-2 md:grid-cols-70/30 w-full gap-6">
          <main>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md mt-6">
              ...
              <p className="mb-4 text-green-600">{job.salary}</p>
            </div>
          </main>
          ...
          <aside>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md mt-6">
              ...
              <Link
                ...
                >Edit Job</Link>
              <button
                className="bg-red-500 hover:bg-red-600 text-white cursor-pointer font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline mt-4 block"
